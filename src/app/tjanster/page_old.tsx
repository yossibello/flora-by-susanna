    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[70vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-4xl mx-auto">
          <h1 className="text-5xl sm:text-6xl md:text-7xl handwritten mb-6">
            Företagsblommor & dekorationer
          </h1>
          <p className="text-xl sm:text-2xl mb-8 leading-relaxed">
            Skapa en välkomnande, inspirerande och professionell miljö med handgjorda blomsterarrangemang.
          </p>
          <a 
            href="#kontakt"
            className="inline-block px-10 py-4 bg-[#8B956D] text-white rounded-full hover:bg-[#7A8B6F] transition-all shadow-lg hover:shadow-xl text-lg font-medium"
          >
            Skicka förfrågan
          </a>
        </div>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-[#6B5B4F] text-xl sm:text-2xl leading-relaxed mb-6">
          ...
          <p className="text-[#6B5B4F] text-lg sm:text-xl leading-relaxed">
            Jag hjälper företag i Brottby, Vallentuna, Täby, Åkersberga och Stockholm med skräddarsydda blomsterlösningar efter behov, säsong och stil.
          </p>
        </div>
      </section>
